...
def test_scren(tmp_path: Path):
    ...
    files: List[Path] = []
    files.append(d / "Screenshot_from_2022-02-03_17-31-04.png")
    files.append(d / "Screenshot from 2022-02-24 14-20-29.png")
    files.append(d / "Screenshot_from_2022-02-22_07-59-01-crop.jpg")
    files.append(d / "Screenshot at 2022-02-12 09-10-04.png")
    files.append(d / "Screenshot_2022-03-01_07-08-42.png")
